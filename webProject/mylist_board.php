            ...
            do {
                ...
                if ($fin) {
                    echo ("
                            ...
                            <input class='check' type='checkbox' index='$todo_index' checked='checked' onclick='check_todo(this)' />
                    ...
                    echo ("
                            ...
                            <input class='check' type='checkbox' index='$todo_index' onclick='check_todo(this)' />
